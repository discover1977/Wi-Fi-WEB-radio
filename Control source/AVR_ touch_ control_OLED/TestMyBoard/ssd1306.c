...
0x7E, 0x11, 0x11, 0x11, 0x7E,// C0 А	CP-1251 table
...
void LCD_Printf(char* buf, unsigned char size, unsigned char inversion) //выводим строку из буфера
{
